...
# === Source files ===
SIM1_SRC = NINTH_TOY_PROBLEM.cpp
SIM2_SRC = ELEVENTH_TOY_PROBLEM.cpp

# === Targets ===
SIM1_TARGET = industrial_simulation1$(EXT)
SIM2_TARGET = industrial_simulation2$(EXT)
