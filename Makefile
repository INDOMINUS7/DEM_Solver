...
# === Targets ===
SIM1_TARGET = industrial_simulations/simulation_logic_cpp/NINTH_TOY_PROBLEM$(EXT)
SIM2_TARGET = industrial_simulations/simulation_logic_cpp/ELEVENTH_TOY_PROBLEM$(EXT)
